...
let website = "/SoccerTypeProvider"
let githubLink = "http://github.com/cnorris2007/SoccerTypeProvider"

// Specify more information about your project
let info =
    [ "project-name", "SoccerTypeProvider"
      "project-author", "Chris Norrisr"
      "project-summary", "type provider for football leagues"
      "project-github", githubLink
      "project-nuget", "http://nuget.org/packages/SoccerTypeProvider" ]
...
let formatting =
    __SOURCE_DIRECTORY__ @@ "../../packages/build/FSharp.Formatting/"
...
let buildDocumentation() =
    ...
    Literate.ProcessDirectory
        (content, docTemplate, output, replacements = ("root", root) :: info,
         layoutRoots = layoutRootsAll.["en"], generateAnchors = true,
    ...
    let subdirs =
        Directory.EnumerateDirectories
            (content, "*", SearchOption.TopDirectoryOnly)
    for dir in subdirs do
        ...
        Literate.ProcessDirectory
            (dir, docTemplate, output @@ dirname,
             replacements = ("root", root) :: info, layoutRoots = layoutRoots,
